...
public class RouteService {
    ...
    public Tour getRouteInformation(Tour tour) throws URISyntaxException, IOException, InterruptedException {
        ...
        File outputfile = new File("src/Maps"+ tour.getid()+".png");
    ...
    public Tour getRouteInformationR(Tour tour) throws URISyntaxException, IOException, InterruptedException {
        ...
        Route route = objectMapper.readValue(httpService.handleHttpRequest(url).body(), Route.class);
        ...
        url = "https://www.mapquestapi.com/staticmap/v5/map?key=g6R1j3Y0bqSVIOGYDGzob93YQcS4d5EJ&" +
                ...
                "size=640,480&" +
                "boundingBox=" + route.boundingBox.lr.lat + "," + route.boundingBox.lr.lng + "," + route.boundingBox.ul.lat + "," + route.boundingBox.ul.lng;
